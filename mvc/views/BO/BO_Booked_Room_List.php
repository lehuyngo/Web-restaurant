    ...
    <div class="container" style="padding-top: 20px">
        <div class="row">
            ...
            <div class="col-sm-6 text-end">
                <a class="text-uppercase" href="http://localhost/Admin/RoomList" style="color:black; font-size:20px">Danh sách phòng ở</a>
            </div>
        </div>
    </div>
        ...
        <table class="table table-striped" style="background-color:white;">
            ...
            <tbody>
                <tr>
                    ...
                    <td>0931910JQK</td>
                    <td>01/01/2023</td>
                    <td><a href="http://localhost/Admin/RoomBooked">Chi tiết</a></td>
                ...
                <tr>
                    ...
                    <td>0931910JQK</td>
                    <td>01/01/2023</td>
                    <td><a href="http://localhost/Admin/RoomBooked">Chi tiết</a></td> <!--them link o day-->
                    <td><button type="button" class="btn btn-outline-success" id="confirm_order">Xác nhận</button></td>
                </tr>
                <tr>
                    <td>Nguyen Van C</td>
