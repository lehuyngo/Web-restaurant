    ...
    <div class="container" style="padding-top: 20px">
        <div class="row">
            ...
            <div class="col-sm-6 text-end">
                <a class="text-uppercase" href="http://localhost/OHR/RoomOrderer" style="color:black; font-size:20px">Danh sách đặt phòng</a>
            </div>
        </div>
    </div>
        ...
        <table class="table table-striped" style="background-color:white;">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Trống</td>
                    <td></td>
                    <td><a href="http://localhost/OHR/RoomBill" style="color:black">Hoá đơn</a></td> <!--them link o day-->
